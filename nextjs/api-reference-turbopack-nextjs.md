...
### [Bundle Sizes](https://nextjs.org/docs/app/api-reference/turbopack\#bundle-sizes)
...
- [`experimental.turbopackFileSystemCacheForDev`](https://nextjs.org/docs/app/api-reference/config/next-config-js/turbopackFileSystemCache)
- [`experimental.turbopackFileSystemCacheForBuild`](https://nextjs.org/docs/app/api-reference/config/next-config-js/turbopackFileSystemCache)
...
Turbopack replaces webpack, so `webpack()` configs are not recognized. Use the [`turbopack` config](https://nextjs.org/docs/app/api-reference/config/next-config-js/turbopack) instead.
- **Yarn PnP**
