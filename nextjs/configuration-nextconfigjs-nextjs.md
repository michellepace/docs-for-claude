...
- [**typescript**](https://nextjs.org/docs/app/api-reference/config/next-config-js/typescript): Next.js reports TypeScript errors by default. Learn to opt-out of this behavior here.
