...
sdkScoped: "false"
canonical: /docs/guides/customizing-clerk/adding-items/user-profile
...
<Tabs items={["Next.js", "JavaScript", "Astro", "Vue"]}>
  ...
  <Tab>
    To add custom pages to the `<UserProfile />` component using the <SDKLink href="/docs/reference/javascript/overview" sdks={["js-frontend"]}>JavaScript SDK</SDKLink>, pass the `customPages` property to the `mountUserProfile()` method, as shown in the following example:
