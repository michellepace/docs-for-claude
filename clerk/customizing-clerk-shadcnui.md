---
title: shadcn/ui
description: Learn how to compose Clerk Elements with shadcn/ui to build custom
  sign in and sign up flows.
lastUpdated: 2025-12-03T22:33:41.000Z
sdkScoped: "false"
canonical: /docs/guides/customizing-clerk/elements/examples/shadcn-ui
sourceFile: /docs/guides/customizing-clerk/elements/examples/shadcn-ui.mdx
---
...
2. Install the [Button](https://ui.shadcn.com/docs/components/button), [Card](https://ui.shadcn.com/docs/components/card), [Input](https://ui.shadcn.com/docs/components/input), and [Label](https://ui.shadcn.com/docs/components/label) components within your project
...
2. Add the following animations to your `tailwind.config.js` file:
...
3. Make sure you have your sign in and sign up URLs set in your [environment variables](https://clerk.com/docs/guides/development/customize-redirect-urls#environment-variables).
...
The following example demonstrates how to make a one-time password (<Tooltip><TooltipTrigger>OTP</TooltipTrigger><TooltipContent>An **OTP** stands for one-time password and is a code that is used to authenticate a user. The OTP is typically sent to a user's email address or phone number and must be entered within a certain time period to be valid.</TooltipContent></Tooltip>) input with Clerk Elements. This example will only work if placed within a `Step` in a sign-up or sign-in authentication flow, as shown in [the sign-in](#sign-in) and [sign-up](#sign-up) examples.
