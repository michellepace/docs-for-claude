...
description: Learn which Clerk environment variables are necessary to configure
  your projects.
lastUpdated: 2025-12-05T18:26:53.000Z
sdkScoped: "false"
...
The following environment variable allows you to protect your webhook signing secret. It is read by Clerk's <SDKLink href="/docs/reference/backend/verify-webhook" sdks={["js-backend"]} code={true}>verifyWebhook()</SDKLink> function.
