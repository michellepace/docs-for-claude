...
Wrap your page content with the `StackedLayout` component to create a stacked layout, using the `navbar` prop for your
top navigation menu, and the `sidebar` prop for your mobile menu content:
...
See the [`Navbar`](https://catalyst.tailwindui.com/docs/navbar) and [`Sidebar`](https://catalyst.tailwindui.com/docs/sidebar) docs for more details.
