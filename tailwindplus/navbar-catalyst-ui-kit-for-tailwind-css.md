...
Extends the JSX `<div>` element. This component does not expose any component-specific props.
...
Extends the Headless UI `Button` component or the `Link` component.
...
Extends the JSX `<span>` element. This component does not expose any component-specific props.
...
The `NavbarItem` component can be used either as a `Link` by providing an `href` prop or as a `Button` by omitting the
`href` prop.
...
See the [`Dropdown`](https://catalyst.tailwindui.com/docs/dropdown) docs for more information on building dropdown menus.
...
Make sure to provide an `aria-label` for assistive technology when using avatar-only dropdowns. See the
[`Dropdown`](https://catalyst.tailwindui.com/docs/dropdown) docs for more information on how to build a dropdown menu.

### With mobile menu

If you'd like to add a mobile menu to a navbar, use the [`StackedLayout`](https://catalyst.tailwindui.com/docs/stacked-layout) component which includes
a navbar and a sidebar for mobile:

![Stacked layout demo](https://catalyst.tailwindui.com/stacked-preview.jpeg)![Stacked layout demo](https://catalyst.tailwindui.com/stacked-preview-dark.jpeg)[Open in new tab](https://catalyst.tailwindui.com/demos/stacked)
...
The `Navbar` component itself isn't opinionated about how it should be rendered at different breakpoints, which gives
