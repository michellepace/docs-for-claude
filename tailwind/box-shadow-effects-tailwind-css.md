...
<ApiTable
  rows={[
    ...
    ["shadow-{color}-{shade}", "--tw-shadow-color: var(--color-{color}-{shade});"],
    // Inset shadows
    ...
    ["inset-shadow-{color}-{shade}", "--tw-inset-shadow-color: var(--color-{color}-{shade});"],
    // Rings
    ...
    ["ring-{color}-{shade}", "--tw-ring-color: var(--color-{color}-{shade});"],
    // Inset rings
    ...
    ["inset-ring-{color}-{shade}", "--tw-inset-ring-color: var(--color-{color}-{shade});"],
  ]}
/>
