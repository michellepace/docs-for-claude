[Skip to content](https://vitest.dev/config/#VPContent)
...
Configuration options that are not supported inside a [project](https://vitest.dev/guide/projects) config have  \\*  sign next to them. This means they can only be set in the root Vitest config.

### include [​](https://vitest.dev/config/\#include)
...
When using coverage, Vitest automatically adds test files `include` patterns to coverage's default `exclude` patterns. See [`coverage.exclude`](https://vitest.dev/config/#coverage-exclude).

### exclude [​](https://vitest.dev/config/\#exclude)
...
This option does not affect coverage. If you need to remove certain files from the coverage report, use [`coverage.exclude`](https://vitest.dev/config/#coverage-exclude).
...
### includeSource [​](https://vitest.dev/config/\#includesource)
...
### name [​](https://vitest.dev/config/\#name)

- **Type:**`string | { label: string, color?: LabelColor }`

Assign a custom name to the test project or Vitest process. The name will be visible in the CLI and UI, and available in the Node.js API via [`project.name`](https://vitest.dev/advanced/api/test-project#name).

Color used by CLI and UI can be changed by providing an object with `color` property.

### server [​](https://vitest.dev/config/\#server)

- **Type:**`{ sourcemap?, deps?, ... }`

Module runner options.

#### server.sourcemap [​](https://vitest.dev/config/\#server-sourcemap)
...
#### server.debug [​](https://vitest.dev/config/\#server-debug)

- **Type:**`{ dumpModules?, loadDumppedModules? }`

Module runner debugger options.

#### server.debug.dumpModules [​](https://vitest.dev/config/\#server-debug-dumpmodules)

- **Type:**`boolean | string`

Dump the transformed module to filesystem. Passing a string will dump to the specified path.

#### server.debug.loadDumppedModules [​](https://vitest.dev/config/\#server-debug-loaddumppedmodules)

- **Type:**`boolean`

Read dumped module from filesystem whenever exists. Useful for debugging by modifying the dump result from the filesystem.

#### server.deps [​](https://vitest.dev/config/\#server-deps)

- **Type:**`{ external?, inline?, ... }`

Handling for dependencies resolution.

#### server.deps.external [​](https://vitest.dev/config/\#server-deps-external)
...
These options support package names as they are written in `node_modules` or specified inside [`deps.moduleDirectories`](https://vitest.dev/config/#deps-moduledirectories). For example, package `@company/some-name` located inside `packages/some-name` should be specified as `some-name`, and `packages` should be included in `deps.moduleDirectories`. Basically, Vitest always checks the file path, not the actual package name.

If regexp is used, Vitest calls it on the _file path_, not the package name.

#### server.deps.inline [​](https://vitest.dev/config/\#server-deps-inline)
...
#### server.deps.fallbackCJS [​](https://vitest.dev/config/\#server-deps-fallbackcjs)
...
#### server.deps.cacheDir [​](https://vitest.dev/config/\#server-deps-cachedir)
...
#### deps.optimizer [​](https://vitest.dev/config/\#deps-optimizer)
...
#### deps.optimizer.{mode}.enabled [​](https://vitest.dev/config/\#deps-optimizer-mode-enabled)
...
#### deps.client [​](https://vitest.dev/config/\#deps-client)
...
Usually, files inside `node_modules` are externalized, but these options also affect files in [`server.deps.external`](https://vitest.dev/config/#server-deps-external).

#### deps.client.transformAssets [​](https://vitest.dev/config/\#deps-client-transformassets)
...
At the moment, this option only works with [`vmThreads`](https://vitest.dev/config/#vmthreads) and [`vmForks`](https://vitest.dev/config/#vmforks) pools.

#### deps.client.transformCss [​](https://vitest.dev/config/\#deps-client-transformcss)
...
If CSS files are disabled with [`css`](https://vitest.dev/config/#css) options, this option will just silence `ERR_UNKNOWN_FILE_EXTENSION` errors.

WARNING

At the moment, this option only works with [`vmThreads`](https://vitest.dev/config/#vmthreads) and [`vmForks`](https://vitest.dev/config/#vmforks) pools.

#### deps.client.transformGlobPattern [​](https://vitest.dev/config/\#deps-client-transformglobpattern)
...
#### deps.interopDefault [​](https://vitest.dev/config/\#deps-interopdefault)
...
#### deps.moduleDirectories [​](https://vitest.dev/config/\#deps-moduledirectories)

- **Type:**`string[]`
- **Default**: `['node_modules']`

A list of directories that should be treated as module directories. This config option affects the behavior of [`vi.mock`](https://vitest.dev/api/vi#vi-mock): when no factory is provided and the path of what you are mocking matches one of the `moduleDirectories` values, Vitest will try to resolve the mock by looking for a `__mocks__` folder in the [root](https://vitest.dev/config/#root) of the project.
...
### runner [​](https://vitest.dev/config/\#runner)
...
### benchmark [​](https://vitest.dev/config/\#benchmark)

- **Type:**`{ include?, exclude?, ... }`

Options used when running `vitest bench`.

#### benchmark.include [​](https://vitest.dev/config/\#benchmark-include)
...
#### benchmark.exclude [​](https://vitest.dev/config/\#benchmark-exclude)
...
#### benchmark.includeSource [​](https://vitest.dev/config/\#benchmark-includesource)

- **Type:**`string[]`
- **Default:**`[]`

Include globs for in-source benchmark test files. This option is similar to [`includeSource`](https://vitest.dev/config/#includesource).

When defined, Vitest will run all matched files with `import.meta.vitest` inside.

#### benchmark.reporters [​](https://vitest.dev/config/\#benchmark-reporters)
...
#### benchmark.outputFile [​](https://vitest.dev/config/\#benchmark-outputfile)

Deprecated in favor of `benchmark.outputJson`.

#### benchmark.outputJson [​](https://vitest.dev/config/\#benchmark-outputJson)
...
#### benchmark.compare [​](https://vitest.dev/config/\#benchmark-compare)
...
### alias [​](https://vitest.dev/config/\#alias)
...
1. Aliases affect only modules imported directly with an `import` keyword by an [inlined](https://vitest.dev/config/#server-deps-inline) module (all source code is inlined by default).
...
### environment [​](https://vitest.dev/config/\#environment)
...
If you are running Vitest with [`--isolate=false`](https://vitest.dev/config/#isolate) flag, your tests will be run in this order: `node`, `jsdom`, `happy-dom`, `edge-runtime`, `custom environments`. Meaning, that every test with the same environment is grouped, but is still running sequentially.
...
### environmentOptions [​](https://vitest.dev/config/\#environmentoptions)

- **Type:**`Record<'jsdom' | string, unknown>`
- **Default:**`{}`

These options are passed down to `setup` method of current [`environment`](https://vitest.dev/config/#environment). By default, you can configure only JSDOM options, if you are using it as your test environment.

### update \\* [​](https://vitest.dev/config/\#update)
...
### watch \\* [​](https://vitest.dev/config/\#watch)
...
### watchTriggerPatterns 3.2.0\+  \\* [​](https://vitest.dev/config/\#watchtriggerpatterns)
...
Returned files should be either absolute or relative to the root. Note that this is a global option, and it cannot be used inside of [project](https://vitest.dev/guide/projects) configs.

### root [​](https://vitest.dev/config/\#root)
...
### dir [​](https://vitest.dev/config/\#dir)
...
### reporters \\* [​](https://vitest.dev/config/\#reporters)

- **Type:**`Reporter | Reporter[]`
- **Default:**`'default'`
- **CLI:**`--reporter=<name>`, `--reporter=<name1> --reporter=<name2>`

Custom [reporters](https://vitest.dev/guide/reporters) for output. Reporters can be [a Reporter instance](https://github.com/vitest-dev/vitest/blob/main/packages/vitest/src/node/types/reporter.ts), a string to select built-in reporters, or a path to a custom implementation (e.g. `'./path/to/reporter.ts'`, `'@scope/reporter'`).

### outputFile \\* [​](https://vitest.dev/config/\#outputfile)
...
#### forks [​](https://vitest.dev/config/\#forks)
...
#### vmThreads [​](https://vitest.dev/config/\#vmthreads)

Run tests using [VM context](https://nodejs.org/api/vm.html) (inside a sandboxed environment) in a `threads` pool.

This makes tests run faster, but the VM module is unstable when running [ESM code](https://github.com/nodejs/node/issues/37648). Your tests will [leak memory](https://github.com/nodejs/node/issues/33439) \- to battle that, consider manually editing [`vmMemoryLimit`](https://vitest.dev/config/#vmmemorylimit) value.
...
#### vmForks [​](https://vitest.dev/config/\#vmforks)
...
### execArgv [​](https://vitest.dev/config/\#execargv)
...
### vmMemoryLimit [​](https://vitest.dev/config/\#vmmemorylimit)
...
This option doesn't affect tests running in the same file. If you want to run those in parallel, use `concurrent` option on [describe](https://vitest.dev/api/#describe-concurrent) or via [a config](https://vitest.dev/config/#sequence-concurrent).
...
### testTimeout [​](https://vitest.dev/config/\#testtimeout)
...
### hookTimeout [​](https://vitest.dev/config/\#hooktimeout)
...
### teardownTimeout \\* [​](https://vitest.dev/config/\#teardowntimeout)
...
### silent \\* [​](https://vitest.dev/config/\#silent)
...
Note, that if you are running [`--isolate=false`](https://vitest.dev/config/#isolate), this setup file will be run in the same global scope multiple times. Meaning, that you are accessing the same global object before each test, so make sure you are not doing the same thing more than you need.
...
### provide 2.1.0\+ [​](https://vitest.dev/config/\#provide)
...
Beware that the global setup is running in a different global scope, so your tests don't have access to variables defined here. However, you can pass down serializable data to tests via [`provide`](https://vitest.dev/config/#provide) method:
...
You can use [`v8`](https://vitest.dev/guide/coverage#v8-provider), [`istanbul`](https://vitest.dev/guide/coverage#istanbul-provider) or [a custom coverage solution](https://vitest.dev/guide/coverage#custom-coverage-provider) for coverage collection.
...
#### coverage.provider [​](https://vitest.dev/config/\#coverage-provider)
...
#### coverage.include [​](https://vitest.dev/config/\#coverage-include)
...
See [Including and excluding files from coverage report](https://vitest.dev/guide/coverage#including-and-excluding-files-from-coverage-report) for examples.

#### coverage.exclude [​](https://vitest.dev/config/\#coverage-exclude)
...
#### coverage.clean [​](https://vitest.dev/config/\#coverage-clean)
...
#### coverage.cleanOnRerun [​](https://vitest.dev/config/\#coverage-cleanonrerun)
...
#### coverage.reportsDirectory [​](https://vitest.dev/config/\#coverage-reportsdirectory)
...
#### coverage.reporter [​](https://vitest.dev/config/\#coverage-reporter)
...
#### coverage.reportOnFailure [​](https://vitest.dev/config/\#coverage-reportonfailure)
...
#### coverage.allowExternal [​](https://vitest.dev/config/\#coverage-allowexternal)
...
#### coverage.excludeAfterRemap 2.1.0\+ [​](https://vitest.dev/config/\#coverage-exclude-after-remap)
...
#### coverage.skipFull [​](https://vitest.dev/config/\#coverage-skipfull)
...
##### coverage.thresholds.lines [​](https://vitest.dev/config/\#coverage-thresholds-lines)
...
##### coverage.thresholds.functions [​](https://vitest.dev/config/\#coverage-thresholds-functions)
...
##### coverage.thresholds.branches [​](https://vitest.dev/config/\#coverage-thresholds-branches)
...
##### coverage.thresholds.statements [​](https://vitest.dev/config/\#coverage-thresholds-statements)
...
##### coverage.thresholds.perFile [​](https://vitest.dev/config/\#coverage-thresholds-perfile)
...
##### coverage.thresholds.100 [​](https://vitest.dev/config/\#coverage-thresholds-100)
...
##### coverage.thresholds\[glob-pattern\] [​](https://vitest.dev/config/\#coverage-thresholds-glob-pattern)
...
##### coverage.thresholds\[glob-pattern\].100 2.1.0\+ [​](https://vitest.dev/config/\#coverage-thresholds-glob-pattern-100)
...
#### coverage.ignoreClassMethods [​](https://vitest.dev/config/\#coverage-ignoreclassmethods)
...
#### coverage.watermarks [​](https://vitest.dev/config/\#coverage-watermarks)
...
#### coverage.processingConcurrency [​](https://vitest.dev/config/\#coverage-processingconcurrency)
...
#### coverage.customProviderModule [​](https://vitest.dev/config/\#coverage-customprovidermodule)
...
### testNamePattern \\* [​](https://vitest.dev/config/\#testnamepattern)
...
### open \\* [​](https://vitest.dev/config/\#open)
...
### api [​](https://vitest.dev/config/\#api)
...
Configuration for running browser tests. Please, refer to the ["Browser Config Reference"](https://vitest.dev/guide/browser/config) article.
...
Will call [`vi.clearAllMocks()`](https://vitest.dev/api/vi#vi-clearallmocks) before each test. This will clear mock history without affecting mock implementations.

### mockReset [​](https://vitest.dev/config/\#mockreset)

- **Type:**`boolean`
- **Default:**`false`

Will call [`vi.resetAllMocks()`](https://vitest.dev/api/vi#vi-resetallmocks) before each test. This will clear mock history and reset each implementation.
...
Will call [`vi.restoreAllMocks()`](https://vitest.dev/api/vi#vi-restoreallmocks) before each test.

This restores all original implementations on spies created with [`vi.spyOn`](https://vitest.dev/config/#vi-spyon).

### unstubEnvs [​](https://vitest.dev/config/\#unstubenvs)
...
### unstubGlobals [​](https://vitest.dev/config/\#unstubglobals)
...
### snapshotFormat \\* [​](https://vitest.dev/config/\#snapshotformat)
...
If you need to extend snapshot serializer via pretty-format plugins, please, use [`expect.addSnapshotSerializer`](https://vitest.dev/api/expect#expect-addsnapshotserializer) API or [snapshotSerializers](https://vitest.dev/config/#snapshotserializers) option.

### snapshotSerializers \\* [​](https://vitest.dev/config/\#snapshotserializers)
...
### resolveSnapshotPath \\* [​](https://vitest.dev/config/\#resolvesnapshotpath)
...
### logHeapUsage [​](https://vitest.dev/config/\#logheapusage)
...
### css [​](https://vitest.dev/config/\#css)
...
#### css.include [​](https://vitest.dev/config/\#css-include)
...
#### css.exclude [​](https://vitest.dev/config/\#css-exclude)
...
#### css.modules [​](https://vitest.dev/config/\#css-modules)

- **Type**: `{ classNameStrategy? }`
- **Default**: `{}`

#### css.modules.classNameStrategy [​](https://vitest.dev/config/\#css-modules-classnamestrategy)
...
### sequence [​](https://vitest.dev/config/\#sequence)
...
#### sequence.sequencer \\* [​](https://vitest.dev/config/\#sequence-sequencer)
...
If [`sequencer.groupOrder`](https://vitest.dev/config/#grouporder) is specified, the sequencer will be called once for each group and pool.

#### groupOrder 3.2.0\+ [​](https://vitest.dev/config/\#grouporder)

- **Type:**`number`
- **Default:**`0`

Controls the order in which this project runs its tests when using multiple [projects](https://vitest.dev/guide/projects).

- Projects with the same group order number will run together, and groups are run from lowest to highest.
- If you don’t set this option, all projects run in parallel.
- If several projects use the same group order, they will run at the same time.

This setting only affects the order in which projects run, not the order of tests within a project. To control test isolation or the order of tests inside a project, use the [`isolate`](https://vitest.dev/config/#isolate) and [`sequence.sequencer`](https://vitest.dev/config/#sequence-sequencer) options.
...
#### sequence.shuffle [​](https://vitest.dev/config/\#sequence-shuffle)
...
#### sequence.shuffle.files [​](https://vitest.dev/config/\#sequence-shuffle-files)
...
#### sequence.shuffle.tests [​](https://vitest.dev/config/\#sequence-shuffle-tests)
...
#### sequence.concurrent [​](https://vitest.dev/config/\#sequence-concurrent)
...
When you run tests with `sequence.concurrent` and `expect.requireAssertions` set to `true`, you should use [local expect](https://vitest.dev/guide/test-context#expect) instead of the global one. Otherwise, this may cause false negatives in [some situations (#8469)](https://github.com/vitest-dev/vitest/issues/8469).

#### sequence.seed \\* [​](https://vitest.dev/config/\#sequence-seed)
...
#### sequence.hooks [​](https://vitest.dev/config/\#sequence-hooks)
...
#### sequence.setupFiles [​](https://vitest.dev/config/\#sequence-setupfiles)
...
#### typecheck.enabled [​](https://vitest.dev/config/\#typecheck-enabled)
...
#### typecheck.only [​](https://vitest.dev/config/\#typecheck-only)
...
#### typecheck.checker [​](https://vitest.dev/config/\#typecheck-checker)
...
#### typecheck.include [​](https://vitest.dev/config/\#typecheck-include)
...
#### typecheck.exclude [​](https://vitest.dev/config/\#typecheck-exclude)
...
#### typecheck.allowJs [​](https://vitest.dev/config/\#typecheck-allowjs)
...
#### typecheck.ignoreSourceErrors [​](https://vitest.dev/config/\#typecheck-ignoresourceerrors)
...
#### typecheck.tsconfig [​](https://vitest.dev/config/\#typecheck-tsconfig)
...
#### typecheck.spawnTimeout [​](https://vitest.dev/config/\#typecheck-spawntimeout)
...
### slowTestThreshold \\* [​](https://vitest.dev/config/\#slowtestthreshold)
...
### chaiConfig [​](https://vitest.dev/config/\#chaiconfig)
...
#### chaiConfig.includeStack [​](https://vitest.dev/config/\#chaiconfig-includestack)
...
#### chaiConfig.showDiff [​](https://vitest.dev/config/\#chaiconfig-showdiff)
...
#### chaiConfig.truncateThreshold [​](https://vitest.dev/config/\#chaiconfig-truncatethreshold)
...
### bail [​](https://vitest.dev/config/\#bail)
...
### retry [​](https://vitest.dev/config/\#retry)
...
### onConsoleLog \\* [​](https://vitest.dev/config/\#onconsolelog)
...
### onStackTrace \\* [​](https://vitest.dev/config/\#onstacktrace)
...
### onUnhandledError \\* [​](https://vitest.dev/config/\#onunhandlederror)
...
If you want unhandled errors to be reported without impacting the test outcome, consider using the [`dangerouslyIgnoreUnhandledErrors`](https://vitest.dev/config/#dangerouslyignoreunhandlederrors) option
...
### diff [​](https://vitest.dev/config/\#diff)
...
#### diff.expand [​](https://vitest.dev/config/\#diff-expand)
...
#### diff.truncateThreshold [​](https://vitest.dev/config/\#diff-truncatethreshold)
...
#### diff.truncateAnnotation [​](https://vitest.dev/config/\#diff-truncateannotation)
...
#### diff.truncateAnnotationColor [​](https://vitest.dev/config/\#diff-truncateannotationcolor)
...
#### diff.printBasicPrototype [​](https://vitest.dev/config/\#diff-printbasicprototype)
...
#### diff.maxDepth [​](https://vitest.dev/config/\#diff-maxdepth)
...
#### fakeTimers.now [​](https://vitest.dev/config/\#faketimers-now)
...
#### fakeTimers.toFake [​](https://vitest.dev/config/\#faketimers-tofake)
...
#### fakeTimers.shouldAdvanceTime [​](https://vitest.dev/config/\#faketimers-shouldadvancetime)
...
#### fakeTimers.advanceTimeDelta [​](https://vitest.dev/config/\#faketimers-advancetimedelta)
...
#### fakeTimers.shouldClearNativeTimers [​](https://vitest.dev/config/\#faketimers-shouldclearnativetimers)
...
An array of [projects](https://vitest.dev/guide/projects).
...
Should `location` property be included when Vitest API receives tasks in [reporters](https://vitest.dev/config/#reporters). If you have a lot of tests, this might cause a small performance regression.
...
### snapshotEnvironment [​](https://vitest.dev/config/\#snapshotEnvironment)
...
If you just need to configure snapshots feature, use [`snapshotFormat`](https://vitest.dev/config/#snapshotformat) or [`resolveSnapshotPath`](https://vitest.dev/config/#resolvesnapshotpath) options.

### env [​](https://vitest.dev/config/\#env)
...
### expect [​](https://vitest.dev/config/\#expect)

- **Type:**`ExpectOptions`

#### expect.requireAssertions [​](https://vitest.dev/config/\#expect-requireassertions)
...
#### expect.poll [​](https://vitest.dev/config/\#expect-poll)
...
##### expect.poll.interval [​](https://vitest.dev/config/\#expect-poll-interval)
...
##### expect.poll.timeout [​](https://vitest.dev/config/\#expect-poll-timeout)
...
### printConsoleTrace [​](https://vitest.dev/config/\#printconsoletrace)
...
### attachmentsDir 3.2.0\+ [​](https://vitest.dev/config/\#attachmentsdir)

- **Type:**`string`
- **Default:**`'.vitest-attachments'`

Directory path for storing attachments created by [`context.annotate`](https://vitest.dev/guide/test-context#annotate) relative to the project root.