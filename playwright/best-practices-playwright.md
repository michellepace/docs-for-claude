[Skip to main content](https://playwright.dev/docs/best-practices#__docusaurus_skipToContent_fallback)

On this page

## Introduction [​](https://playwright.dev/docs/best-practices\#introduction "Direct link to Introduction")

This guide should help you to make sure you are following our best practices and writing tests that are more resilient.

## Testing philosophy [​](https://playwright.dev/docs/best-practices\#testing-philosophy "Direct link to Testing philosophy")

### Test user-visible behavior [​](https://playwright.dev/docs/best-practices\#test-user-visible-behavior "Direct link to Test user-visible behavior")

Automated tests should verify that the application code works for the end users, and avoid relying on implementation details such as things which users will not typically use, see, or even know about such as the name of a function, whether something is an array, or the CSS class of some element. The end user will see or interact with what is rendered on the page, so your test should typically only see/interact with the same rendered output.

### Make tests as isolated as possible [​](https://playwright.dev/docs/best-practices\#make-tests-as-isolated-as-possible "Direct link to Make tests as isolated as possible")
...
### Avoid testing third-party dependencies [​](https://playwright.dev/docs/best-practices\#avoid-testing-third-party-dependencies "Direct link to Avoid testing third-party dependencies")
...
### Testing with a database [​](https://playwright.dev/docs/best-practices\#testing-with-a-database "Direct link to Testing with a database")

If working with a database then make sure you control the data. Test against a staging environment and make sure it doesn't change. For visual regression tests make sure the operating system and browser versions are the same.

## Best Practices [​](https://playwright.dev/docs/best-practices\#best-practices "Direct link to Best Practices")

### Use locators [​](https://playwright.dev/docs/best-practices\#use-locators "Direct link to Use locators")
...
#### Use chaining and filtering [​](https://playwright.dev/docs/best-practices\#use-chaining-and-filtering "Direct link to Use chaining and filtering")
...
#### Prefer user-facing attributes to XPath or CSS selectors [​](https://playwright.dev/docs/best-practices\#prefer-user-facing-attributes-to-xpath-or-css-selectors "Direct link to Prefer user-facing attributes to XPath or CSS selectors")
...
### Generate locators [​](https://playwright.dev/docs/best-practices\#generate-locators "Direct link to Generate locators")
...
#### Use `codegen` to generate locators [​](https://playwright.dev/docs/best-practices\#use-codegen-to-generate-locators "Direct link to use-codegen-to-generate-locators")
...
#### Use the VS Code extension to generate locators [​](https://playwright.dev/docs/best-practices\#use-the-vs-code-extension-to-generate-locators "Direct link to Use the VS Code extension to generate locators")
...
### Use web first assertions [​](https://playwright.dev/docs/best-practices\#use-web-first-assertions "Direct link to Use web first assertions")
...
#### Don't use manual assertions [​](https://playwright.dev/docs/best-practices\#dont-use-manual-assertions "Direct link to Don't use manual assertions")
...
### Configure debugging [​](https://playwright.dev/docs/best-practices\#configure-debugging "Direct link to Configure debugging")

#### Local debugging [​](https://playwright.dev/docs/best-practices\#local-debugging "Direct link to Local debugging")
...
#### Debugging on CI [​](https://playwright.dev/docs/best-practices\#debugging-on-ci "Direct link to Debugging on CI")
...
### Use Playwright's Tooling [​](https://playwright.dev/docs/best-practices\#use-playwrights-tooling "Direct link to Use Playwright's Tooling")
...
### Test across all browsers [​](https://playwright.dev/docs/best-practices\#test-across-all-browsers "Direct link to Test across all browsers")
...
### Keep your Playwright dependency up to date [​](https://playwright.dev/docs/best-practices\#keep-your-playwright-dependency-up-to-date "Direct link to Keep your Playwright dependency up to date")
...
### Run tests on CI [​](https://playwright.dev/docs/best-practices\#run-tests-on-ci "Direct link to Run tests on CI")
...
#### Optimize browser downloads on CI [​](https://playwright.dev/docs/best-practices\#optimize-browser-downloads-on-ci "Direct link to Optimize browser downloads on CI")
...
### Lint your tests [​](https://playwright.dev/docs/best-practices\#lint-your-tests "Direct link to Lint your tests")
...
### Use parallelism and sharding [​](https://playwright.dev/docs/best-practices\#use-parallelism-and-sharding "Direct link to Use parallelism and sharding")
...
## Productivity tips [​](https://playwright.dev/docs/best-practices\#productivity-tips "Direct link to Productivity tips")

### Use Soft assertions [​](https://playwright.dev/docs/best-practices\#use-soft-assertions "Direct link to Use Soft assertions")
