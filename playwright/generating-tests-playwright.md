[Skip to main content](https://playwright.dev/docs/codegen-intro#__docusaurus_skipToContent_fallback)

On this page

## Introduction [​](https://playwright.dev/docs/codegen-intro\#introduction "Direct link to Introduction")
...
## Running Codegen [​](https://playwright.dev/docs/codegen-intro\#running-codegen "Direct link to Running Codegen")
...
### Recording a test [​](https://playwright.dev/docs/codegen-intro\#recording-a-test "Direct link to Recording a test")
...
### Generating locators [​](https://playwright.dev/docs/codegen-intro\#generating-locators "Direct link to Generating locators")
...
### Emulation [​](https://playwright.dev/docs/codegen-intro\#emulation "Direct link to Emulation")
...
## What's Next [​](https://playwright.dev/docs/codegen-intro\#whats-next "Direct link to What's Next")
