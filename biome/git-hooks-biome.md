[Skip to content](https://biomejs.dev/recipes/git-hooks/#_top)
...
[Section titled “Lefthook”](https://biomejs.dev/recipes/git-hooks/#lefthook)
...
[Section titled “Husky”](https://biomejs.dev/recipes/git-hooks/#husky)
...
[Section titled “lint-staged”](https://biomejs.dev/recipes/git-hooks/#lint-staged)
...
[Section titled “git-format-staged”](https://biomejs.dev/recipes/git-hooks/#git-format-staged)
...
[Section titled “pre-commit”](https://biomejs.dev/recipes/git-hooks/#pre-commit)
...
In the following example, we assume that you [installed pre-commit](https://pre-commit.com/#install) and run `pre-commit install` in your repository.
...
Instead of using the provided Biome hooks, you can specify your own [local hook](https://pre-commit.com/#repository-local-hooks).
...
[Section titled “Shell script”](https://biomejs.dev/recipes/git-hooks/#shell-script)
