[Skip to content](https://docs.marimo.io/guides/working_with_data/plotting/#plotting)

# Plotting [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#plotting "Permanent link")
...
[`mo.ui.plotly`](https://docs.marimo.io/api/plotting/#marimo.ui.plotly "            marimo.ui.plotly") to connect frontend
selections to Python!

Reactive plots!

marimo supports reactive plots via
[`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart") and
[`mo.ui.plotly`](https://docs.marimo.io/api/plotting/#marimo.ui.plotly "            marimo.ui.plotly")! Select and
filter with your mouse, and marimo _automatically makes the selected data_
_available in Python as a Pandas dataframe_!

## Reactive plots! ⚡ [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#reactive-plots "Permanent link")
...
### Altair [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#altair "Permanent link")
...
Use [`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart") to easily
create interactive, selectable plots: _selections you make on the frontend are_
_automatically made available as Pandas dataframes in Python._

Wrap an Altair chart in [`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart")
to make it **reactive**: select data on the frontend, access it via the chart's
`value` attribute (`chart.value`).

#### Disabling automatic selection [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#disabling-automatic-selection "Permanent link")
...
#### Example [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#example "Permanent link")
...
#### Learning Altair [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#learning-altair "Permanent link")
...
##### Concepts [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#concepts "Permanent link")
...
#### Automatic Selections [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#automatic-selections "Permanent link")

By default [`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart")
...
[`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart") will also
make the legend selectable.

Selection configurable through `*_selection` params in
[`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart"). See the [API\\
docs](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart") for details.
...
#### Altair transformations [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#altair-transformations "Permanent link")
...
### Plotly [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#plotly "Permanent link")

mo.ui.plotly only supports scatter plots, treemaps charts, and sunbursts charts

marimo can render any Plotly plot, but [`mo.ui.plotly`](https://docs.marimo.io/api/plotting/#marimo.ui.plotly "            marimo.ui.plotly") only
supports reactive selections for scatter plots, treemaps charts, and sunbursts charts. If you require other kinds of
selection, consider using [`mo.ui.altair_chart`](https://docs.marimo.io/api/plotting/#marimo.ui.altair_chart "            marimo.ui.altair_chart").
...
Use [`mo.ui.plotly`](https://docs.marimo.io/api/plotting/#marimo.ui.plotly "            marimo.ui.plotly") to create
selectable Plotly plots whose values are sent back to Python on selection.

## matplotlib [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#matplotlib "Permanent link")
...
### Interactive plots [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#interactive-plots "Permanent link")

To make matplotlib plots interactive, use
[mo.mpl.interactive](https://docs.marimo.io/api/plotting/#marimo.mpl.interactive "            marimo.mpl.interactive").
(Matplotlib plots are not yet reactive.)

## Chart builder [¶](https://docs.marimo.io/guides/working_with_data/plotting/\#chart-builder "Permanent link")
...
This feature is in active development. Please report any issues or feedback on the [marimo GitHub issues page](https://github.com/marimo-team/marimo/issues).
