[Skip to content](https://docs.marimo.io/recipes/#recipes)

# Recipes [¶](https://docs.marimo.io/recipes/\#recipes "Permanent link")
...
## Control Flow [¶](https://docs.marimo.io/recipes/\#control-flow "Permanent link")

### Show an output conditionally [¶](https://docs.marimo.io/recipes/\#show-an-output-conditionally "Permanent link")
...
### Run a cell on a timer [¶](https://docs.marimo.io/recipes/\#run-a-cell-on-a-timer "Permanent link")
...
configuration's](https://docs.marimo.io/guides/configuration/runtime_configuration/)`on cell
change` should be set to `autorun`

### Require form submission before sending UI value [¶](https://docs.marimo.io/recipes/\#require-form-submission-before-sending-ui-value "Permanent link")
...
### Stop execution of a cell and its descendants [¶](https://docs.marimo.io/recipes/\#stop-execution-of-a-cell-and-its-descendants "Permanent link")
...
3. Use [`mo.stop`](https://docs.marimo.io/api/control_flow/#marimo.stop "            marimo.stop") to stop execution when
...
## Grouping UI elements together [¶](https://docs.marimo.io/recipes/\#grouping-ui-elements-together "Permanent link")

### Create an array of UI elements [¶](https://docs.marimo.io/recipes/\#create-an-array-of-ui-elements "Permanent link")

**Use cases.** In order to synchronize UI elements between the frontend and
backend (Python), marimo requires you to
[assign UI elements to global variables](https://docs.marimo.io/guides/interactivity/).
...
[`mo.ui.array`](https://docs.marimo.io/api/inputs/array/#marimo.ui.array "            marimo.ui.array"), which lets you make
...
2. Use [`mo.ui.array`](https://docs.marimo.io/api/inputs/array/#marimo.ui.array "            marimo.ui.array") to group together
...
### Create a dictionary of UI elements [¶](https://docs.marimo.io/recipes/\#create-a-dictionary-of-ui-elements "Permanent link")
...
2. Use [`mo.ui.dictionary`](https://docs.marimo.io/api/inputs/dictionary/#marimo.ui.dictionary "            marimo.ui.dictionary") to
...
### Embed a dynamic number of UI elements in another output [¶](https://docs.marimo.io/recipes/\#embed-a-dynamic-number-of-ui-elements-in-another-output "Permanent link")
...
[`mo.ui.array`](https://docs.marimo.io/api/inputs/array/#marimo.ui.array "            marimo.ui.array"), then retrieve them from the container
...
### Create a hstack (or vstack) of UI elements with `on_change` handlers [¶](https://docs.marimo.io/recipes/\#create-a-hstack-or-vstack-of-ui-elements-with-on_change-handlers "Permanent link")
...
### Create a table column of buttons with `on_change` handlers [¶](https://docs.marimo.io/recipes/\#create-a-table-column-of-buttons-with-on_change-handlers "Permanent link")
...
### Create a form with multiple UI elements [¶](https://docs.marimo.io/recipes/\#create-a-form-with-multiple-ui-elements "Permanent link")
...
2. Use [`mo.ui.form`](https://docs.marimo.io/api/inputs/form/#marimo.ui.form "            marimo.ui.form") and [`Html.batch`](https://docs.marimo.io/api/html/#marimo.Html.batch "            batch") to
...
### Populating form with pre-defined examples [¶](https://docs.marimo.io/recipes/\#populating-form-with-pre-defined-examples "Permanent link")
...
The form can also be populated from [URL query parameters](https://docs.marimo.io/api/query_params/) ( [notebook example](https://marimo.app/l/w21a3x?t1=query&t2=params)).
...
## Working with buttons [¶](https://docs.marimo.io/recipes/\#working-with-buttons "Permanent link")

### Create a button that triggers computation when clicked [¶](https://docs.marimo.io/recipes/\#create-a-button-that-triggers-computation-when-clicked "Permanent link")

**Use cases.** To trigger a computation on button click and only on button
click, use [`mo.ui.run_button()`](https://docs.marimo.io/api/inputs/run_button/).
...
### Create a counter button [¶](https://docs.marimo.io/recipes/\#create-a-counter-button "Permanent link")
...
2. Use [`mo.ui.button`](https://docs.marimo.io/api/inputs/button/#marimo.ui.button "            marimo.ui.button") and its
...
### Create a toggle button [¶](https://docs.marimo.io/recipes/\#create-a-toggle-button "Permanent link")
...
[`mo.ui.switch`](https://docs.marimo.io/api/inputs/switch/#marimo.ui.switch "            marimo.ui.switch").)
...
### Re-run a cell when a button is pressed [¶](https://docs.marimo.io/recipes/\#re-run-a-cell-when-a-button-is-pressed "Permanent link")
...
### Run a cell when a button is pressed, but not before [¶](https://docs.marimo.io/recipes/\#run-a-cell-when-a-button-is-pressed-but-not-before "Permanent link")
...
### Reveal an output when a button is pressed [¶](https://docs.marimo.io/recipes/\#reveal-an-output-when-a-button-is-pressed "Permanent link")
...
## Caching [¶](https://docs.marimo.io/recipes/\#caching "Permanent link")

### Cache function outputs in memory [¶](https://docs.marimo.io/recipes/\#cache-function-outputs-in-memory "Permanent link")
...
### Persistent caching for very expensive computations [¶](https://docs.marimo.io/recipes/\#persistent-caching-for-very-expensive-computations "Permanent link")
...
[`mo.persistent_cache`](https://docs.marimo.io/api/caching/#marimo.persistent_cache "            marimo.persistent_cache").
